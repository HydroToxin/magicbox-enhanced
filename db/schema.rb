...
ActiveRecord::Schema[7.1].define(version: 20_241_005_001_758) do
  ...
  create_table 'notifications', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[notifications_type notifications_id],
            name: 'index_notifications_on_notifications_type_and_notifications_id'
    t.index %w[notified_type notified_id], name: 'index_notifications_on_notified_type_and_notified_id'
