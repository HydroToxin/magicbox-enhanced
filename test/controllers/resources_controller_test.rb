...
class ResourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create resource' do
    assert_difference('Resource.count') do
      post resources_url,
           params: { resource: { category_id: @resource.category_id, choices: @resource.choices,
                                 description: @resource.description, name: @resource.name, shortname: @resource.shortname, units: @resource.units } }
    end
