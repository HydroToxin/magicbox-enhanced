...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create batch' do
    assert_difference('Batch.count') do
      post batches_url,
           params: { batch: { batch_count: @batch.batch_count, batch_weight: @batch.batch_weight, grow_id: @batch.grow_id,
                              harvest_id: @batch.harvest_id, name: @batch.name, total_weight: @batch.total_weight } }
    end
