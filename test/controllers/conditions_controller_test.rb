...
class ConditionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create condition' do
    assert_difference('Condition.count') do
      post conditions_url,
           params: { condition: { data_type_id: @condition.data_type_id, end_time: @condition.end_time, name: @condition.name,
                                  predicate: @condition.predicate, start_time: @condition.start_time, target_value: @condition.target_value } }
    end
