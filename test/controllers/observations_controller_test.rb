...
class ObservationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create observation' do
    assert_difference('Observation.count') do
      post observations_url,
           params: { observation: { body: @observation.body, grow_id: @observation.grow_id, nutrients: @observation.nutrients,
                                    room_id: @observation.room_id, subject_id: @observation.subject_id, user_id: @observation.user_id, water: @observation.water } }
    end
  ...
  test 'should update observation' do
    patch observation_url(@observation),
          params: { observation: { body: @observation.body, grow_id: @observation.grow_id, nutrients: @observation.nutrients,
                                   room_id: @observation.room_id, subject_id: @observation.subject_id, user_id: @observation.user_id, water: @observation.water } }
