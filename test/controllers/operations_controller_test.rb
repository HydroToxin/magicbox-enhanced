...
class OperationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create operation' do
    assert_difference('Operation.count') do
      post operations_url,
           params: { operation: { command: @operation.command, condition_id: @operation.condition_id, delay: @operation.delay,
                                  description: @operation.description, device_id: @operation.device_id, retries: @operation.retries } }
    end
