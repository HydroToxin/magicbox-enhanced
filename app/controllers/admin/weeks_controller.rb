...
module Admin
  # Admin::WeeksController
  class WeeksController < Admin::AdminController
    before_action :authenticate_user!
    before_action :set_grow
    before_action :set_week, except: %i[new create]
    ...
    def week_params
      params.require(:week).permit(:id, :week_type, :week_number, :start_date, :end_date, :grow_id)
    end
  end
end
