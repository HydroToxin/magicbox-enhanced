...
json.extract! room, :id, :name, :room_type, :length, :width, :height, :created_at, :updated_at, :current_temperature,
              :current_humidity
...
json.samples room.samples.limit(5) do |sample|
  json.extract! sample, :id, :product_reference, :data_type_id, :value, :unit, :created_at, :updated_at, :device_id,
                :html_color, :category_name
end
